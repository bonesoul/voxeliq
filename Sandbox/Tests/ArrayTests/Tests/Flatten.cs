...
{
    public sealed class Flatten : ArrayTest
    {
        private int[] _storage;

        public Flatten(int dimensionSize)
            : base(dimensionSize) { }
        ...
        public override TimeSpan AccessSequental()
        {
            ...
            int dimensionSizeOverTwo = DimensionSize*DimensionSize;
            ...
            for (int x = 0; x < DimensionSize; x++)
            {
                ...
                {
                    int xzLoc = x*dimensionSizeOverTwo + y*DimensionSize;
                    for (int z = 0; z < DimensionSize; z++)
                    {
                        _storage[xzLoc + z] = counter;
                        counter++;
                    }
                }
            }
        ...
        public override TimeSpan AccessRandom()
        {
            ...
            for (int x = 0; x < DimensionSize; x++)
            {
                ...
                {
                    int xzLoc = x * dimensionSizeOverTwo + y * DimensionSize;
                    int xzLocReverse = (dimensionMinusOne - x)*dimensionSizeOverTwo + (dimensionMinusOne - y)*DimensionSize;
                    for (int z = 0; z < DimensionSize; z++)
                    {
                        if (bSwitch) _storage[xzLoc + z] = counter;
                        else _storage[xzLocReverse + (dimensionMinusOne - z)] = counter;
                        counter++;
                        bSwitch = !bSwitch;
                    }
                }
