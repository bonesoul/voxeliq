...
namespace VoxeliqEngine.Debugging.Graphs
{
    public class FPSGraph:DebugGraph
    {
        ...
        public override void DrawStrings(GameTime gameTime)
        {
            ...
            SpriteBatch.DrawString(SpriteFont, "fps", new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
            SpriteBatch.DrawString(SpriteFont, "curr:" + CurrentValue, new Vector2(Bounds.Left + 25, Bounds.Bottom), Color.White);
        ...
        public override void DrawGraph(GameTime gameTime)
        {
            ...
            DrawSolidPolygon(Background, 4, Color.Black, true);
            ...
            {
                float y1 = Bounds.Bottom - ((GraphValues[i] / (AdaptiveMaximum - AdaptiveMinimum)) * yScale);
                float y2 = Bounds.Bottom - ((GraphValues[i - 1] / (AdaptiveMaximum - AdaptiveMinimum)) * yScale);
