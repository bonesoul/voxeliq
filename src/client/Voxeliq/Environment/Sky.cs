    ...
    public class Sky : DrawableGameComponent, ISky
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            if (this._dynamicCloudsEnabled) // if dynamic-cloud generation is on, generate them.
                this.GenerateDynamicClouds(gameTime);
        ...
        /// </summary>
        /// <param name="gameTime"></param>
        private void GenerateDynamicClouds(GameTime gameTime)
        {
            this.GraphicsDevice.SetRenderTarget(this._cloudsRenderTarget);
