...
namespace DigitalRune.Game.UI.Controls
{
  ...
  /// <remarks>
  /// <para>
  /// Buttons can be pressed using the left mouse button, or the ENTER or SPACE keys on the
  /// keyboard or the A button on the gamepad (when the button is focused).
  /// </para>
  /// <para>
