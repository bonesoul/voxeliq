...
namespace DigitalRune.Game.UI.Controls
{
  ...
  {
    // Contains a panel with TabItems. In the content area the TabItem.TabPage of the selected
    // item is displayed.
    ...
    {
      // TabItems are added to the panel. We must make sure the same order is used in Items
      // and in the panel. 
