...
namespace DigitalRune.Game.UI.Controls
{
  ...
  /// <see cref="ContentControl"/>. The <see cref="UIControl.Padding"/> is applied to the bounds
  /// of the <see cref="Content"/>.
  /// </remarks>
  public class ContentControl : UIControl
  {
    ...
    protected override Vector2F OnMeasure(Vector2F availableSize)
    {
      ...
      {
        var contentSize = hasContent ? Content.DesiredWidth : 0;
      ...
      {
        var contentSize = hasContent ? Content.DesiredHeight : 0;
