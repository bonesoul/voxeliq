...
namespace DigitalRune.Game.UI.Controls
{
  public partial class UIControl
  {
    ...
    private class UIProperty<T> : IUIProperty
    {
      public string Name;
    ...
    private class UIEvent<T> : IUIEvent where T : EventArgs
    {
      public int EventId;
    ...
    /// <remarks>
    /// These class-specific default values are applied to the template when the control is
    /// loaded.
    /// </remarks>
    /// <exception cref="ArgumentNullException">
    /// <paramref name="ownerType"/> is <see langword="null"/>.
