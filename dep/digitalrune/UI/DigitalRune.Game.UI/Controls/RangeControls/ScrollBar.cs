...
namespace DigitalRune.Game.UI.Controls
{
  ...
  public class ScrollBar : RangeBase
  {
    ...
    /// </value>
    /// <remarks>
    /// The <see cref="ViewportSize"/> defines the size of the dragable <see cref="Thumb"/>.
    /// </remarks>
    ...
    protected override void OnHandleInput(InputContext context)
    {
      ...
      if (_thumb != null)
      {
        ...
        if (_thumb.IsDragging && !Numeric.AreEqual(minimum, maximum))
        {
          ...
          {
            var contentHeight = ActualHeight - padding.Y - padding.W - _thumb.ActualHeight;
    ...
    protected override void OnArrange(Vector2F position, Vector2F size)
    {
      ...
      if (_thumb != null)
      {
        ...
        if (Orientation == Orientation.Horizontal)
        {
          var contentWidth = ActualWidth - padding.X - padding.Z;
        ...
        {
          var contentHeight = ActualHeight - padding.Y - padding.W;
          ...
          var thumbCenterPosition = contentHeight / range * (value - Minimum);
          if (Numeric.AreEqual(minimum, maximum))
            thumbCenterPosition = 0;
