  ...
  public static class ThemeHelper
  {
    ...
    public static HorizontalAlignment ParseHorizontalAlignment(string value)
    {
      ...
      switch (value.Trim().ToUpperInvariant())
      {
        ...
        default:
          var message = string.Format("Could not parse horizontal alignment: '{0}'", value);
    ...
    public static VerticalAlignment ParseVerticalAlignment(string value)
    {
      ...
      switch (value.Trim().ToUpperInvariant())
      {
        ...
        default:
          var message = string.Format("Could not parse vertical alignment: '{0}'", value);
          throw new FormatException(message);
      }
    }
    ...
    public static TileMode ParseTileMode(string value)
    {
      ...
      switch (value.Trim().ToUpperInvariant())
      {
        ...
        default:
          var message = string.Format("Could not parse tile mode: '{0}'", value);
          throw new FormatException(message);
      }
    }
    ...
    public static Color ParseColor(string value, Color defaultColor)
    {
      ...
      try
      {
        var vector = ParseVector4F(value);
        return new Color((byte)vector.X, (byte)vector.Y, (byte)vector.Z, (byte)vector.W);
      }
      catch (Exception exception)
      {
        string message = string.Format("Could not parse color: '{0}'", value);
    ...
    public static Vector2F ParseVector2F(string value)
    {
      ...
      if (values.Length != 2)
      {
        string message = string.Format("Could not parse 2-element vector: '{0}'", value);
        throw new FormatException(message);
      }
    ...
    public static Vector3F ParseVector3F(string value)
    {
      ...
      if (values.Length != 3)
      {
        string message = string.Format("Could not parse 3-element vector: '{0}'", value);
        throw new FormatException(message);
      }
    ...
    public static Vector4F ParseVector4F(string value)
    {
      ...
      if (values.Length != 4)
      {
        string message = string.Format("Could not parse 4-element vector: '{0}'", value);
        throw new FormatException(message);
      }
    ...
    public static Rectangle ParseRectangle(string value)
    {
      ...
      {
        string message = string.Format("Could not parse rectangle: '{0}'", value);
        throw new FormatException(message, exception);
      }
    }
  }
