...
namespace DigitalRune.Game.UI.Rendering
{
  ...
  /// </para>
  /// <para>
  /// <strong>Inherited states:</strong> Controls that are nested inside other controls (e.g.
  /// a <see cref="TextBlock"/> inside a <see cref="Button"/>) can inherit a visual state from its
