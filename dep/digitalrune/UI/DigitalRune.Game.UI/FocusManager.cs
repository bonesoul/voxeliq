...
namespace DigitalRune.Game.UI
{
  ...
  public class FocusManager
  {
    ...
    /// this method does nothing. Use <see cref="ClearFocus"/> to remove the focus from a control.)
    /// </param>
    /// <returns>
    ...
    internal void MoveFocus(UIControl control, LogicalPlayerIndex allowedPlayer)
    {
      ...
      // Check left thumb stick and dpad.
      ...
      UIControl target = OnMoveFocus(moveLeft, moveRight, moveUp, moveDown, _focusableControls);      
    ...
    protected virtual UIControl OnMoveFocus(bool moveLeft, bool moveRight, bool moveUp, bool moveDown, List<UIControl> focusableControls)
    {
      ...
      foreach (var candidate in focusableControls)
      {
        ...
        var distance = GetDistance(focusedControlBounds, candidateBounds);
    ...
    /// <param name="control">The control.</param>
    /// <remarks>
    /// The focusable controls are stored in _focusableControls.
    /// <see cref="FocusedControl"/> will be excluded from the list.
    /// </remarks>
    ...
    /// rectangle).
    /// </summary>
    /// <param name="rectangle0">The rectangle0.</param>
