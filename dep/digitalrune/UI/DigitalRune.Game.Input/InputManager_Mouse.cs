...
namespace DigitalRune.Game.Input
{
  partial class InputManager
  {
    ...
    /// <inheritdoc/>
    private static bool IsDown(ref MouseState mousteState, MouseButtons button)
    {
      switch (button)
      {
        case MouseButtons.Left:
          return mousteState.LeftButton == ButtonState.Pressed;
        case MouseButtons.Middle:
          return mousteState.MiddleButton == ButtonState.Pressed;
        case MouseButtons.Right:
          return mousteState.RightButton == ButtonState.Pressed;
        case MouseButtons.XButton1:
          return mousteState.XButton1 == ButtonState.Pressed;
        case MouseButtons.XButton2:
          return mousteState.XButton2 == ButtonState.Pressed;
        default:
          return false;
      }
    }
