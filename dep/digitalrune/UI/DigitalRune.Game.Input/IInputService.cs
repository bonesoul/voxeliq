...
namespace DigitalRune.Game.Input
{
  ...
  /// that is assigned to <strong>PlayerIndex.One</strong>! A  game needs to detect which player
  /// uses which game controller at runtime. (See example below.)
  /// </para>
  /// <para>
  ...
  /// </strong> is true and <strong>IsPressed</strong> is true. If the key  is still held down in
  /// the next frame, <strong>IsDown</strong> is still true but <strong>IsPressed</strong> is false.
  /// </para>
  /// <para>
  ...
  public interface IInputService
  {
    ...
    /// <summary>
    /// Gets the game controller assigned to the specified player.
    /// </summary>
    /// <param name="player">
    ...
    /// <summary>
    /// Assigns a game controller to a player.
    /// </summary>
    /// <param name="player">
    /// The <see cref="LogicalPlayerIndex"/> that identifies the player.
    /// </param>
    ...
    /// <overloads>
    /// <summary>
    /// Sets the <strong>IsGamePadHandled</strong> flags.
    /// </summary>
    /// </overloads>
    /// <summary>
    /// Sets the <strong>IsGamePadHandled</strong> flags for the given player.
    /// </summary>
    /// <param name="player">
    /// The <see cref="LogicalPlayerIndex"/> that identifies the player. 
    ...
    /// <overloads>
    /// <summary>
    /// Gets the state of a game controller.
    /// </summary>
    /// </overloads>
    /// <summary>
    ...
    /// <summary>
    /// Gets the gamepad state of the given game controller.
    /// </summary>
    /// <param name="controller">
    /// The <see cref="PlayerIndex"/> that identifies the game controller.
    /// </param>
    ...
    /// <overloads>
    /// <summary>
    /// Gets the gamepad state of the last frame.
    /// </summary>
    /// </overloads>
    /// <summary>
    ...
    /// <summary>
    /// Gets the detected touch gestures.
    /// </summary>
    /// <value>The detected touch gestures.</value>
    /// <remarks>
    /// <strong>TouchPanel.EnabledGestures</strong> must be set to enable gesture detection. 
    ...
    /// <overloads>
    /// <summary>
    /// Determines whether the specified button or key is down.
    /// </summary>
    /// </overloads>
    /// <summary>
    ...
    /// <overloads>
    /// <summary>
    /// Determines whether the specified button or key is up.
    /// </summary>
    /// </overloads>
    /// <summary>
