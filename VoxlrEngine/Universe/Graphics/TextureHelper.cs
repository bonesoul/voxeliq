...
{    
    ...
    public static class TextureHelper
    {
        ...
        /// </summary>
        const float UnitBlockTextureOffset = 1f / BlockTextureAtlasSize;
        ...
        /// </summary>
        const float UnitCrackTextureOffset = 1f / CrackTextureAtlasSize;
        ...
        private static void BuildCrackTextureMappings()
        {
            for (int i = 0; i < 256; i++)
            {
                CrackTextureMappings.Add((i * 6), GetCrackTextureMapping(i, BlockFaceDirection.XIncreasing));     // build x-increasing mapping for the texture.
                CrackTextureMappings.Add((i * 6) + 1, GetCrackTextureMapping(i, BlockFaceDirection.XDecreasing)); // build x-decreasing mapping for the texture.
                CrackTextureMappings.Add((i * 6) + 2, GetCrackTextureMapping(i, BlockFaceDirection.YIncreasing)); // build y-increasing mapping for the texture.
                CrackTextureMappings.Add((i * 6) + 3, GetCrackTextureMapping(i, BlockFaceDirection.YDecreasing)); // build y-decreasing mapping for the texture.
                CrackTextureMappings.Add((i * 6) + 4, GetCrackTextureMapping(i, BlockFaceDirection.ZIncreasing)); // build z-increasing mapping for the texture.
                CrackTextureMappings.Add((i * 6) + 5, GetCrackTextureMapping(i, BlockFaceDirection.ZDecreasing)); // build z-increasing mapping for the texture.   
            }
        }
